...
public class QueryUtil {
        ...
        /**
         * Return a list of {@link com.example.android.quakereport.EarthQuake} objects that has been built up from
         * parsing a JSON response.
         */
        public static ArrayList<com.example.android.quakereport.EarthQuake> extractEarthquakes() {

            // Create an empty ArrayList that we can start adding earthquakes to
            ArrayList<com.example.android.quakereport.EarthQuake> earthquakes = new java.util.ArrayList<>();
            ...
            try {
                ...
                JSONObject jsonObject = new org.json.JSONObject(SAMPLE_JSON_RESPONSE);
                JSONArray jsonArray = jsonObject.getJSONArray("Feature");
                for (int i=0;i<jsonArray.length();i++){
                    JSONObject curentEarthQuake = jsonArray.getJSONObject(i);
                    JSONObject properties = curentEarthQuake.getJSONObject("properties");
                    String magnetude = properties.getString("mag");
                    String location = properties.getString("place");
                    Long time = properties.getLong("time");
                    EarthQuake earthQuake = new EarthQuake(magnetude,location,time);
                ...
                android.util.Log.e("QueryUtils", "Problem parsing the earthquake JSON results", e);
            }
